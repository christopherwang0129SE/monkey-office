...
| [wall-variant.md](hardware/wall-variant.md) | V1.0-wall (4-timers print) |

### Tekniske assets
- [`cad/`](cad/) — OpenSCAD parametric source (`monkey.scad`, `monkey-wall.scad`)
- [`stl/`](stl/) — desktop variant STLs + renders; [`stl/wall/`](stl/wall/) — wall variant
...
**Vil du printe?** Læs [hardware/PRINT.md](hardware/PRINT.md) og åbn [prints/aben.3mf](prints/aben.3mf) i Bambu Studio.
